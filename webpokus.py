...
def display_five_player_segments():
    ...
    if selected_team:
        ...
        for i, match in enumerate(team_matches):
            ...
            home_team = match[1]
            away_team = match[2]
            home_score = match[3]  # Assuming these columns exist
            away_score = match[4]
        ...
        if selected_match:
            ...
            # Display results (this part remains the same as your existing code)
            if lineup_data is not None and not lineup_data.empty:
                ...
                # For example, a bar chart of lineup performance
                ...
                st.write("No lineup data available for this game.")
def get_teams():
